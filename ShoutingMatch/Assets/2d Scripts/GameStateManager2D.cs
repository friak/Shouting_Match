...
public sealed class GameStateManager2D : MonoBehaviour
{
    private static GameStateManager2D _instance;
    public static GameStateManager2D Instance
    {
        get
        {
            return _instance;
    ...
    public Player2D[] Players { get; set; }
    ...
    private void Start()
    {
        ...
        Players[0] = new Player2D("/dev/cu.usbmodem141101", defaultCharacter1, d1);
        Players[1] = new Player2D("/dev/cu.usbmodem142101", defaultCharacter2, d2);
    }
